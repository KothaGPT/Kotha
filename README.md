...
**Kotha** is a full-stack web framework designed for speed and simplicity. It provides essential tools and libraries to help developers build modern web applications with ease.
...
Create a new **Kotha** project with a single command:

```sh
# Initialize a new Kotha project
