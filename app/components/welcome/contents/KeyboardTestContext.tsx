...
import { getKothaModeShortcutDefaults } from '@/lib/constants/keyboard-defaults'
...
export default function KeyboardTestContent() {
  ...
  const keyboardShortcut = getKothaModeShortcuts(KothaMode.TRANSCRIBE)[0]
  const platform = usePlatform()
  const defaultKeys =
    getKothaModeShortcutDefaults(platform)[KothaMode.TRANSCRIBE]
