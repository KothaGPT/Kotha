...
export class ObservabilityStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: ObservabilityStackProps) {
    ...
    const alertTopic = new Topic(this, 'KothaAlarmTopic', {
      topicName: `${stageName}-kotha-alarms`,
      displayName: `Kotha service alarms for ${stageName}`,
    })
    this.alertTopic = alertTopic

    const snsAction = new SnsAction(alertTopic)

    new Alarm(this, `${stageName}-HighKothaFargateCpu`, {
      ...
      actionsEnabled: true,
      alarmName: `${stageName}-kotha-cpu-high`,
    }).addAlarmAction(snsAction)

    new Alarm(this, `${stageName}-HighKothaFargateMemory`, {
      ...
      actionsEnabled: true,
      alarmName: `${stageName}-kotha-memory-high`,
    }).addAlarmAction(snsAction)

    new Alarm(this, `${stageName}-KothaUnhealthyTasks`, {
      ...
      actionsEnabled: true,
      alarmName: `${stageName}-kotha-unhealthy-tasks`,
    }).addAlarmAction(snsAction)
