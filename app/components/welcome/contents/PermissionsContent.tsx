            ...
            <div className="flex flex-col gap-4 my-8 pr-24">
              <div className="border rounded-lg p-4 flex flex-col gap-2 bg-background border-border border-2">
                ...
                >
                  ...
                  <div className="font-medium text-base flex">
                    {isAccessibilityEnabled
                      ? 'Kotha can insert and edit text.'
                      : 'Allow Kotha to insert spoken words.'}
                  </div>
                </div>
                {!isAccessibilityEnabled && (
                  <>
                    <div className="text-sm text-muted-foreground mb-2">
                      This lets Kotha put your spoken words in the right textbox
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="right" align="start">
                            <p>
                              Kotha uses this to gather context based on the
              ...
              <div className="border rounded-lg p-4 flex flex-col gap-2 bg-background border-border border-2">
                ...
                >
                  ...
                  <div className="font-medium text-base flex">
                    {isMicrophoneEnabled
                      ? 'Kotha can use your microphone.'
                      : 'Allow Kotha to use your microphone.'}
                  </div>
                </div>
                {isAccessibilityEnabled && !isMicrophoneEnabled && (
                  <>
                    <div className="text-sm text-muted-foreground mb-2">
                      This lets Kotha hear your voice and transcribe your speech
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 mt-1">
                        <Button
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="right" align="start">
                            <p>
                              Kotha will show an animation when the mic is
