# Claude Context for KOTHA Project

## Project Overview

This is the KOTHA project - an AI assistant application with both client and server components.

## Project Structure

- `app/` - Client application code
- `server/` - Server-side code with gRPC services
- `server/src/kotha.proto` - Protocol buffer definitions
