/**
 * Simple health check utility for the local Kotha server using the main process
 */
...
/**
 * Performs a health check against the local Kotha server via the main process
