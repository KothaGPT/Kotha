...
import (
	...
	"github.com/kothagpt/kotha/ai/internal/app"
	"github.com/kothagpt/kotha/ai/internal/config"
	"github.com/kothagpt/kotha/ai/internal/db"
	"github.com/kothagpt/kotha/ai/internal/format"
	"github.com/kothagpt/kotha/ai/internal/llm/agent"
	"github.com/kothagpt/kotha/ai/internal/logging"
	"github.com/kothagpt/kotha/ai/internal/pubsub"
	"github.com/kothagpt/kotha/ai/internal/tui"
	"github.com/kothagpt/kotha/ai/internal/version"
...
var rootCmd = &cobra.Command{
	...
	Long: `Kotha is a powerful terminal-based AI assistant that helps with software development tasks.
...
to assist developers in writing, debugging, and understanding code directly from the terminal.`,
  ...
  kotha -d -c /path/to/project

  # Print version
  kotha -v

  # Run a single non-interactive prompt
  kotha -p "Explain the use of context in Go"

  # Run a single non-interactive prompt with JSON output format
  kotha -p "Explain the use of context in Go" -f json
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		provider, err := config.Load(cwd, debug)
		if err != nil {
			return err
		}
		...
		app, err := app.New(ctx, conn, provider)
		if err != nil {
